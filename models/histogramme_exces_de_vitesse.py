...
class Histogramme:
    ...
    # Fonction permettant d'avoir les excès de vitesse inférieur à 50km dans une série
    ...
    def affiche_histo_exces_de_vitesse(self):
        ...
        fig = px.histogram(
            ...
            title='Histogramme sur les excès de vitesse <br> par tranche de 5 km/h de 0-50 km/h',       #Titre de l'histogramme
