...
# Fonction qui renvoie une carte folium visualisant le nombre de radars par département
def create_radars_numbers_map(fichier_csv):

    # Lecture du fichier csv
    radars_data = pd.read_csv(fichier_csv, sep=';')
